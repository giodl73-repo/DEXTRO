...
Usage:
    python scripts/compactness/run_calculate_compactness_metrics.py --census-year 2020 --version v1
"""
    ...
    for i, (state_name, num_districts) in enumerate(STATES.items()):
        ...
        try:
            result = subprocess.run(
                [sys.executable, 'scripts/compactness/calculate_compactness_metrics.py',
                 str(state_dir)],
                capture_output=True,
                text=True,
                timeout=300
