...
def main():
    ...
    steps = [
        ...
        ("Cities", f'{sys.executable} {scripts_dir}/add_cities_to_districts.py {state_dir} --state {state_code} --year {args.year} --version {args.version} --position {child_position} {common_flags_str}'.strip()),
        ("Round maps", f'{sys.executable} {scripts_dir}/visualize_all_rounds.py {state_dir} --state {state_code} --year {args.year} --version {args.version} --position {child_position} {common_flags_str}'.strip()),
        ("District maps", f'{sys.executable} {scripts_dir}/visualize_individual_districts.py {state_dir} --state {state_code} --year {args.year} --version {args.version} --position {child_position} {common_flags_str}'.strip())
    ]
