...
34 papers across five tracks. All PDFs are pre-built and open directly. LaTeX sources live under [`research/`](../research/).
...
All 18 B-series papers have PDFs.

| # | Title | PDF | Notes |
|---|-------|-----|-------|
| B.0 | Algorithm Design Overview — Bakeoff | [PDF](papers/B.0+algorithm-design-overview.pdf) | |
| B.02 | ApportionRegions: Redistricting as Geographic Completion of Huntington-Hill | [PDF](papers/B.02+one-federal-law.pdf) | |
| B.1 | Recursive Bisection for Congressional Redistricting | [PDF](papers/B.1+recursive-bisection.pdf) | |
| B.2 | Edge-Weighted Recursive Bisection for Compact Congressional Districts | [PDF](papers/B.2+edge-weighted-bisection.pdf) | |
...
| B.5 | N-Way vs. Recursive Bisection (General) | [PDF](papers/B.5+nway-vs-recursive-general.pdf) | |
| B.6 | Computational Complexity | [PDF](papers/B.6+computational-complexity.pdf) | |
| B.7 | Solution Space and Seed Sensitivity | [PDF](papers/B.7+solution-space-and-seed-sensitivity.pdf) | |
| B.8 | GeoSection — Ratio-Optimal First-Level Bisection | [PDF](papers/B.8+geosection-ratio-optimal-bisection.pdf) | |
| B.9 | AreaSection — Dual Population-Area Constraint | [PDF](papers/B.9+areasection-dual-population-area-constraint.pdf) | |
| B.10 | Subdivision-Respecting Redistricting (county-sticky weights) | [PDF](papers/B.10+subdivision-respecting-redistricting.pdf) | |
| B.11 | ApportionRegions — Geographic Completion of Huntington-Hill | [PDF](papers/B.11+apportion-regions.pdf) | Full paper with peer reviews |
| B.12 | ProportionalSection — Partisan Proportionality via Dual Constraint | [PDF](papers/B.12+proportional-section.pdf) | Full paper with peer reviews |
| B.13 | NestSection — Nested Multi-Chamber Redistricting | [PDF](papers/B.13+nestsection-nested-multi-chamber.pdf) | |
| B.14 | VRASection — Minority Geographic Alignment | [PDF](papers/B.14+vrasection-minority-opportunity-bisection.pdf) | |
| B.15 | StabilitySection — Cross-Census Stability | [PDF](papers/B.15+stabilitysection-cross-census-stability.pdf) | |
| B.16 | ConvergenceSweep — Empirical Seed Sufficiency (T=600) | [PDF](papers/B.16+convergence-sweep.pdf) | |
...
| C.0 | Validation Overview (Track C synthesis) | — | Not yet written |
| C.6 | User Study: Public Perception of Algorithmic Maps | — | Not yet written |
| C.7 | Uncertainty Quantification for Redistricting Metrics | — | Not yet written |
...
| D.4 | Legal Implementation Framework | — | Not yet written |
...
| # | Title | PDF | Status |
|---|-------|-----|--------|
| E.0 | Experimental Overview (Track E synthesis) | — | Not yet written |
...
| E.7 | Lessons Learned | — | Not yet written |
