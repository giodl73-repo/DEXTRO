...
\column{0.5\textwidth}
\includegraphics[width=\textwidth]{figures/example_gerrymander.png}
\begin{center}
\small{\textit{Gerrymandered districts can look very strange!}}
\end{center}
\end{columns}
\end{frame}
...
\column{0.5\textwidth}
\includegraphics[width=\textwidth]{figures/tract_to_graph.png}
\begin{center}
\small{\textit{Real tracts (left) $\rightarrow$ Abstract graph (right)}}
\end{center}
\end{columns}
\end{frame}
