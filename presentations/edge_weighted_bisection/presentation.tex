...
\begin{figure}
\centering
\includegraphics[width=0.98\textwidth]{../../outputs/presentations/edge_weighted_bisection/figures/real_tracts_to_graph.png}
\end{figure}

\vspace{-0.5em}
\small
\textbf{Left:} Actual census tracts from Minneapolis area with irregular shapes\\
\textbf{Right:} Same tracts as graph—nodes (circles), edges (lines), weights (km)
...
\includegraphics[width=\textwidth]{../../outputs/presentations/edge_weighted_bisection/figures/minnesota_round_1_2_regions.png}
\begin{center}\small{Round 1: 2 regions}\end{center}

\column{0.33\textwidth}
\includegraphics[width=\textwidth]{../../outputs/presentations/edge_weighted_bisection/figures/minnesota_round_2_4_regions.png}
\begin{center}\small{Round 2: 4 regions}\end{center}

\column{0.33\textwidth}
\includegraphics[width=\textwidth]{../../outputs/presentations/edge_weighted_bisection/figures/minnesota_round_3_8_regions.png}
...
\begin{columns}
\column{0.33\textwidth}
\includegraphics[width=\textwidth]{../../outputs/presentations/edge_weighted_bisection/figures/alabama_round_1_2_regions.png}
\begin{center}\small{Round 1: 2 regions\\(4 vs 3)}\end{center}

\column{0.33\textwidth}
\includegraphics[width=\textwidth]{../../outputs/presentations/edge_weighted_bisection/figures/alabama_round_2_4_regions.png}
\begin{center}\small{Round 2: 4 regions}\end{center}

\column{0.33\textwidth}
\includegraphics[width=\textwidth]{../../outputs/presentations/edge_weighted_bisection/figures/alabama_round_3_7_regions.png}
