...
NOTE: Excluded from collection via tests/conftest.py collect_ignore.
Imports apportionment.partition which was archived 2026-04-29.
VRA mode is now implemented in Rust (--structure vra-section).
"""
