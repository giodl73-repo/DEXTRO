...
class TestGetTractFile:
    ...
    def test_get_tract_file_basic(self):
        ...
        assert path.as_posix() == 'outputs/data/2020/units/california_tracts_2020.parquet'
    ...
    def test_get_tract_file_spaces_to_underscores(self):
        ...
        assert path.as_posix() == 'outputs/data/2020/units/new_york_tracts_2020.parquet'

    def test_get_tract_file_all_years(self):
        """Test tract file paths for all census years."""
        for year in ['2000', '2010', '2020']:
            path = get_tract_file('california', year)
            assert path.as_posix() == f'outputs/data/{year}/units/california_tracts_{year}.parquet'
...
class TestGetPlacesFile:
    ...
    def test_get_places_file_basic(self):
        ...
        assert isinstance(path, Path)
        assert path.as_posix() == 'outputs/data/2020/places/california_places_2020.parquet'

    def test_get_places_file_normalization(self):
        """Test state name normalization."""
        path = get_places_file('North Dakota', '2020')

        assert path.as_posix() == 'outputs/data/2020/places/north_dakota_places_2020.parquet'
...
class TestGetAdjacencyFile:
    ...
    def test_get_adjacency_file_basic(self):
        ...
        assert isinstance(path, Path)
        assert path.as_posix() == 'outputs/data/2020/adjacency/california_adjacency_2020.pkl'
    ...
    def test_get_adjacency_file_all_years(self):
        ...
        for year in ['2000', '2010', '2020']:
            ...
            assert path.as_posix() == f'outputs/data/{year}/adjacency/texas_adjacency_{year}.pkl'
...
class TestGetElectionDataFile:
    ...
    def test_get_election_data_file_2020(self):
        ...
        assert isinstance(path, Path)
        assert path.as_posix() == 'outputs/data/2020/elections/2020_president_tract.parquet'
...
class TestGetDemographicDataFile:
    ...
    def test_get_demographic_data_file_basic(self):
        ...
        assert isinstance(path, Path)
        assert path.as_posix() == 'outputs/data/2020/demographics/2020_demographics_tract.parquet'
    ...
    def test_get_demographic_data_file_all_years(self):
        ...
        for year in ['2000', '2010', '2020']:
            ...
            assert path.as_posix() == f'outputs/data/{year}/demographics/{year}_demographics_tract.parquet'
