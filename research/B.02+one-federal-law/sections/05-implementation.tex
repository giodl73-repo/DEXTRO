...
Because \ar{} has zero seed variance in practice \citep{b11paper}, the seed
formula is primarily an audit mechanism rather than a decision-making input.
The same map would be produced by any seed.
The formula provides a canonical reference point for independent verification.
