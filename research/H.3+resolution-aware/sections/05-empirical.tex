...
The lag-100 reduction of $\approx 27\%$ is consistent with results reported
by Autry et al.~\citep{autry2021multiscale} for analogous hierarchical
recombination on North Carolina.
...
\begin{enumerate}
  ...
  \item \textbf{Compactness}: district boundary lines can follow finer geographic
        ...
        by 3--8\%\est\ based on analogy with block-group vs.\ tract comparison
        in \citet{herschlag2020quantifying}.
\end{enumerate}
