...
framework of four trade-off dimensions (compactness, proportionality, minority
representation, county preservation) and identified the constitutional
availability of each.  The principal findings are:

\begin{enumerate}
  \item \textbf{No system dominates the baseline on all four dimensions.}
