...
The central finding is striking: for all six states, the projected Democratic
seat count is identical across all five percentile values.
The compactness extremum ($p = 0.0$) and the compactness worst ($p = 1.0$)
produce the same partisan outcome.
This is a complete confirmation of the partisan insensitivity hypothesis.
...
\subsection{The 0.5-Seat Bound}

Across all six states and five percentile values, the maximum variation in
projected D seats for any individual state is 0 seats.
The national variation is 0 seats.
The 0.5-seat bound stated in the abstract is therefore conservative.
