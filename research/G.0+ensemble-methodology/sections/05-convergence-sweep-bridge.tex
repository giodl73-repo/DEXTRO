...
The connection is: both $T$ and \ess{} measure the robustness of a result
to additional sampling.  A plan certified by \cs{} at $T = 600$ is
reproducible (same plan from same census data); an ensemble certified by
\ess{} $> 400$ is reliable (histogram shape stable under additional draws).
These are complementary certificates for different goals.
