...
VRASection passes this test because the counterfactual map --- the pure
...
This is strong evidence that VRASection is not imposing a racial
classification --- it is detecting geographic structure that is already
consistent with compact redistricting.
