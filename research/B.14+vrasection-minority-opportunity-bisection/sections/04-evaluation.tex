...
\midrule
AL & 1:6 & \textbf{2:5} & No (0/28 configs) & TBD: comparison run pending \\
MS & TBD & TBD         & Yes (23/28 configs) & TBD: comparison run pending \\
GA & TBD & TBD         & Yes (27/28 configs) & TBD: comparison run pending \\
NC & 1:13 & TBD        & No (0/28 configs)   & TBD: comparison run pending \\
LA & TBD & TBD         & No (0/28 configs)   & TBD: comparison run pending \\
SC & TBD & TBD         & No (0/28 configs)   & TBD: comparison run pending \\
\bottomrule
\end{tabular}
\end{table}

The Alabama and North Carolina GeoSection ratios (1:6 and 1:13 respectively)
are confirmed from the B.8 50-state sweep.
The VRASection ratio for Alabama (2:5) is confirmed from the implementation
described in \S\ref{sec:alabama}.
All other VRASection cells await a dedicated comparison run.
