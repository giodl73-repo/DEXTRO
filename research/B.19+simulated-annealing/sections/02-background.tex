...
If the cooling schedule satisfies $T(t) \ge C / \log(t+2)$ for a
sufficiently large constant $C$ (the ``logarithmic schedule''), SA converges
to a global optimum with probability one~\citep{kirkpatrick1983}.
