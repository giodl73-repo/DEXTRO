...
\textbf{Replication materials} include Python 3.13+ scripts, METIS bindings (via \texttt{pymetis}), and sample datasets for Vermont and Delaware (smallest states, $\sim$2 minute runtime on commodity hardware). Full 50-state redistricting requires $\sim$40GB census data (U.S. Census Bureau redistricting files for 2000/2010/2020) and 2-4 hours computation on a modern workstation (4-core CPU, 16GB RAM).
...
\textbf{Contact}: giovanni.deluca@example.com
