...
application to states with large seat counts ($k \geq 17$). Every local ensemble
is always 2-way, so bipartition failure is structurally impossible regardless of
the state's seat count $k$.
