...
\input{sections/02c-efficiency-gap-utility-and-limitations}
\input{sections/03-methodology}
\input{sections/03a-algorithm-specification}
\input{sections/04-results}
\input{sections/04f-proportionality-eg-connection}
\input{sections/04g-vra-compliance}
