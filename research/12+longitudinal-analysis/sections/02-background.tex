...
\begin{itemize}
    ...
    \item \textbf{2010}: Post-REDMAP era, sophisticated partisan gerrymandering enabled by modern GIS tools
...
Several studies have examined redistricting trends over time. \citet{altman2011gerrymandering} documented increasing partisan bias from 1972--2010. \citet{henderson2018measuring} analyzed compactness measures across multiple redistricting cycles but used different analytical approaches for different years. \citet{mcghee2014redistricting} examined efficiency gaps across decades but focused on partisan metrics rather than geometric properties.
