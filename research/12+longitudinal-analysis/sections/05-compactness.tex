...
\textbf{Interpretation}: As GIS technology and optimization techniques improved, mapmakers exploited these tools to draw increasingly non-compact districts. The gap between algorithmic (0.46) and enacted (0.28) compactness widened from 40\% in 2000 to 62\% in 2020.
