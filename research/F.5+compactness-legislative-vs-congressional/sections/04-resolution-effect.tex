...
Across all 50 states and three census years (2000/2010/2020), the mean PP improvement from tract to block group resolution is 0.013 PP units (3.4\% improvement relative to tract-resolution PP). For the 2020 census year alone the effect is somewhat larger (approximately 0.020 PP units), because 2020 block group boundaries are more precisely aligned with current geographic features. Table~\ref{tab:main_results} (column 4) reports the block group PP for each state.
