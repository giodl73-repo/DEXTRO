...
NestSection successfully produces nested bicameral maps for all 41 compatible
...
In practice, all 41 compatible states succeed because METIS's balance tolerance
...
In all 41 compatible states, senate districts have lower mean PP than house
