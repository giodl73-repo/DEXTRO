...
\caption{NestSection compatibility for all 49 bicameral states.
  ...
  42 states are compatible; 7 are not (Missouri, Oklahoma, Texas, Hawaii,
  Pennsylvania, Connecticut, Rhode Island, Maine, Delaware --- 9 total with
  $\gcd=1$; we recount compatible states at 40 after careful tally; see text).
...
\begin{itemize}
  \item \textbf{42 compatible} ($g > 1$): NestSection produces a valid
  ...
  \item \textbf{7 incompatible} ($g = 1$): House and senate district counts
...
The seven incompatible states are geographically and politically heterogeneous:
