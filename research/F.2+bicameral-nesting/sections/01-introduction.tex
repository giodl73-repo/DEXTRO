...
\begin{enumerate}
  ...
  \item Application of NestSection to all 41 compatible states, producing
  ...
  \item A classification of the 8 incompatible states ($\gcd = 1$) and
...
Section~\ref{sec:results} reports NestSection results for the 41 compatible states.
