...
\gc{} with pair reselection also handles these states.
\re{}'s advantage is that Rust's throughput reduces the wall time for
the pair-reselection warm-up phase from seconds (Python) to microseconds,
making cold-start runs practical within a pipeline budget.
