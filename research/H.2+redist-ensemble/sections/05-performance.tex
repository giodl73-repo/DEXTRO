...
\bench\,\gc{} fails on TX ($k=38$) and CA ($k=52$) from cold start due to bipartition infeasibility;
\re{} handles via pair reselection (Section~\ref{ssec:tx}).
\end{table}
...
California ($k=52$) presents the highest per-step cost due to its
large $n$ and high $k$.
The estimated 0.52 seconds for 10{,}000 steps still represents a
dramatic improvement over \gc{}'s inability to complete even 1{,}000
