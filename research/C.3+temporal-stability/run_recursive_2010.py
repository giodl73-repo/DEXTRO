"""
Run recursive bisection partitioning for 2010 census data.
...
def run_recursive_partition(state_code: str, year: str = '2010'):
...
def main():
    ...
    print("="*70)
    print("2010 RECURSIVE BISECTION FOR TEMPORAL STABILITY ANALYSIS")
    print("="*70)
    ...
    for state_code in STATES:
        try:
            elapsed = run_recursive_partition(state_code, '2010')
