...
Used together, these provide a stronger legal argument than either
alone: the plan cannot be challenged as gerrymandered by compactness
(ILP certificate) or by partisan outcome (ensemble analysis).
