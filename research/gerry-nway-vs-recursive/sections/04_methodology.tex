...
\textbf{Platform}: Python 3.13, GeoPandas 0.14 (spatial operations), NumPy 1.26 (numerical computation), Pandas 2.1 (data analysis). Executed on Intel Xeon workstation with 64GB RAM (sufficient for largest state, California: 9,129 tracts).
