...
We use \texttt{ufactor=1}, corresponding to maximum 0.1\% imbalance. This exceeds the legal requirement of 0.5\% population deviation~\cite{karcher1993}, providing a safety margin for floating-point precision.
