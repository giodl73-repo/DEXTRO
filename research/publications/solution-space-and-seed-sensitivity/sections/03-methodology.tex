...
In practice, with $\delta = 0.05$ (5\% gap tolerance), a challenger would
need to produce a bisection with geometric-mean PP more than 5\% higher than
the certified plan's. If the certifier stopped at $\delta < 0.01$ (within 1\%
of theoretical maximum), the attack becomes computationally infeasible.
