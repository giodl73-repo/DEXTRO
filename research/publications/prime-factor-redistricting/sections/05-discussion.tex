...
PFR's constitutional argument is most compelling when every state has at least
...
\item PFR's prime-factorisation tree is non-trivial for all 50 states,
  enabling the two-level geographic decomposition that makes PFR's
  constitutional argument strongest.
\end{itemize}

\paragraph{Connection to the PFR constitutional claim.}
The minimum-three threshold is not merely a curiosity.
It is the point at which PFR's analogy between apportionment and redistricting
...
a 1{,}405-seat House with PFR would produce maps in which no state is
winner-take-all at the congressional delegation level.
The two mechanisms --- Huntington-Hill for interstate apportionment,
PFR for intrastate geographic decomposition --- would form a coherent
...
remain winner-take-all single-member districts, exempt from PFR's
...
that makes the PFR tree non-trivial for every state.
