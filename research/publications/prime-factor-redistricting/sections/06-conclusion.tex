...
We have introduced Prime-Factored Redistricting (PFR), an algorithm that
...
The constitutional argument is that PFR extends Huntington-Hill
...
forcing a full map redesign. This is not a defect of PFR --- it is a
consequence of the mathematics. Any redistricting algorithm that takes the
arithmetic of seat counts seriously will face the same transitions. PFR makes
...
and the PFR-smooth variant for minimising tract reassignments.
