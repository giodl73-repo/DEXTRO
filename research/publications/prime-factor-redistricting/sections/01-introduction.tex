...
\emph{Prime-Factored Redistricting} (PFR) algorithm is a direct geographic
...
The most practically significant feature of PFR is that geographic splits are
...
PFR also makes visible a previously unrecognized structural phenomenon:
...
breaks occur and propose a continuity-preserving variant (PFR-smooth) that
minimises structural change across reapportionments.

\paragraph{Contributions.}
\begin{enumerate}
  \item \textbf{Algorithm}: The PFR algorithm --- a deterministic,
        ...
        + census geography).
  \item \textbf{Constitutional argument}: A formal claim that PFR maps
  ...
  \item \textbf{Empirical evaluation}: Full PFR maps for all 50 states at
  ...
  \item \textbf{PFR-smooth}: A reapportionment-stable variant that preserves
