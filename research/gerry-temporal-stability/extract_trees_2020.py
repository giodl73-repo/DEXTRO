"""
Extract hierarchical tree structures from 2020 recursive bisection runs.

Loads adjacency data from outputs/v1/data/2020/ and re-runs recursive bisection
...
def extract_tree_for_state(state_code: str, state_name: str, n_districts: int, year: str = '2020'):
...
def main():
    ...
    print("="*60)
    print("TREE EXTRACTION - 2020")
    print("="*60)

    for state_code, (state_name, n_districts) in STATES.items():
        try:
            extract_tree_for_state(state_code, state_name, n_districts, '2020')
