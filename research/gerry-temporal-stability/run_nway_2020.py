"""
Run n-way partitioning for 2020 census data.
...
def run_nway_partition(state_code: str, year: str = '2020'):
...
def main():
    ...
    print("="*70)
    print("2020 N-WAY PARTITIONING FOR TEMPORAL STABILITY ANALYSIS")
    print("="*70)
    ...
    for state_code in STATES:
        try:
            elapsed = run_nway_partition(state_code, '2020')
