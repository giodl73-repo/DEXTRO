"""
Run TRUE recursive bisection partitioning for 2020 census data.
...
def run_true_recursive_partition(state_code: str, year: str = '2020'):
...
def main():
    ...
    print("="*70)
    print("2020 TRUE RECURSIVE BISECTION FOR TEMPORAL STABILITY")
    print("="*70)
    ...
    for state_code in STATES:
        try:
            elapsed = run_true_recursive_partition(state_code, '2020')
