...
% Figures
\input{figures/figure1-architecture}
% Figure 2: National map (requires data-driven generation - see figures/README_figure2.md)
\input{figures/figure3-vra-analysis}
\input{figures/figure4-temporal-stability}
