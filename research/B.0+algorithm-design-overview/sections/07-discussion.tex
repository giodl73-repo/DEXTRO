...
GerryChain \citep{metric2018} and related MCMC approaches generate large ensembles
of redistricting plans and test whether an enacted map falls within the ensemble's
distribution.
These methods are well-suited to null-hypothesis testing (``is the enacted map
unusual?'') but not to plan generation.
The toolbox is complementary: it generates plans, while GerryChain tests them.
